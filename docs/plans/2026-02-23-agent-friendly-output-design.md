...
### 当前问题
从用户截图 `temp/82480422f7658b3c46274f308aa85c26.png` 可以看到，SkillHub Agent 在执行工具时缺少说明性文字：
...
1. **系统级控制**：输出风格由 SkillHub 系统控制，Skill 开发者无需关心
...
你是一个智能 AI 助手，运行在 SkillHub 平台上。你的目标是帮助用户完成各种任务。
