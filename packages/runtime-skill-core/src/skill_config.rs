...
pub struct SkillConfig {
    ...
    pub optional_toolsets: Option<Vec<String>>,
    pub denied_toolsets: Option<Vec<String>>,
...
struct FrontMatter {
    ...
    #[serde(alias = "requires-toolsets", alias = "required_toolsets")]
    requires_toolsets: Option<AllowedToolsValue>,
    #[serde(alias = "optional-toolsets")]
    optional_toolsets: Option<AllowedToolsValue>,
    #[serde(alias = "denied-toolsets")]
    denied_toolsets: Option<AllowedToolsValue>,
...
impl SkillConfig {
    pub fn parse(content: &str) -> Self {
        ...
        Self {
            ...
            requires_toolsets: fm.requires_toolsets.map(|v| v.into_vec()),
            optional_toolsets: fm.optional_toolsets.map(|v| v.into_vec()),
            denied_toolsets: fm.denied_toolsets.map(|v| v.into_vec()),
