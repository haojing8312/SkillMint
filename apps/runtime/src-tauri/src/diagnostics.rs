...
mod tests {
    ...
    use super::{
        clear_active_run_marker, detect_abnormal_previous_run, ensure_diagnostics_dirs,
        read_latest_crash_summary, record_crash_summary, write_log_record, CrashSummary,
        DiagnosticsPaths, LogLevel,
    };
